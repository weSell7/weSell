<?php
	...
	$sql = "SELECT * FROM kitchen WHERE discount != 0";

	$result = mysqli_query($db,$sql);

	if($result->num_rows){
		echo "<center><a href='kitchen.html'><button>Back</button></a>";
	...
	$sql = "SELECT * FROM kitchen ORDER BY price";
	...
	$sql = "SELECT * FROM kitchen ORDER BY price DESC";
