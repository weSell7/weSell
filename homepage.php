...
<html lang = " en ">
	<head>
        ...
        <!--jPlayer: JavaScript library developed as a jQuery plugin-->
        <link href="jplayer/jplayer.blue.monday.min.css" rel="stylesheet" type="text/css" />
    ...
    $("#jquery_jplayer_1").jPlayer({
        ready: function () {
            $(this).jPlayer("setMedia", {
                title: "weSell &copy;", //Title
                m4v: "media/vid.mp4",         //File location
            });
        },
        swfPath: "jplayer",
