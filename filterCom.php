<?php
	...
	$sql = "SELECT * FROM cc WHERE discount != 0";

	$result = mysqli_query($db,$sql);

	if($result->num_rows){
		echo "<center><a href='computer.html'><button>Back</button></a>";
	...
	$sql = "SELECT * FROM cc ORDER BY price";
	...
	$sql = "SELECT * FROM cc ORDER BY price DESC";
